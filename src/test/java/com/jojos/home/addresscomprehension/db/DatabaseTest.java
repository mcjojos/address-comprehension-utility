...
public class DatabaseTest {
    ...
    public void test1InsertAndRetrieveCompaniesAndAddresses() throws MalformedURLException {
        ...
        try {
            ...
            Assert.assertTrue("Addresses stored and addresses retrieved should match. Retrieved: " + retrievedAddressesStr + ", addresses: " + addressesStr,
                    retrievedAddresses.values().containsAll(addresses));
